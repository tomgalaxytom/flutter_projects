...
class _ExpansionPanelScreenState extends State<ExpansionPanelScreen> {
  ...
  void initState() {
    super.initState();
    isOpenList = List<bool>.generate(
        7, (index) => false); // Initialize all panels to closed
  }

  ExpansionPanel expansionPanel(int index, String name, String description) {
    return ExpansionPanel(
      isExpanded: isOpenList[index], // Read the expansion state from the list
      ...
      body: SingleChildScrollView(
        child: ExpansionPanelList(
          ...
          expansionCallback: (index, isOpen) {
            setState(() {
              isOpenList[index] =
                  !isOpenList[index]; // Toggle the expansion state
            });
          },
          children: [
